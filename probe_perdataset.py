...
extracted. Outputs: 5 small-multiple PNGs + perdataset_summary.json.
"""
...
def make_grid(fig_path, suptitle, curves_for, draw_ci, draw_argmax, legend_handles):
    ...
    fig.savefig(OUT_DIR / fig_path, dpi=130, bbox_inches="tight")
    plt.close(fig)
...
def main():
    ...
    with open(OUT_DIR / "perdataset_summary.json", "w") as f:
